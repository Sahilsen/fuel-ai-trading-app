...
export declare class TransactionResponse {
     ...
     */
    constructor(tx: string | TransactionRequest, provider: Provider, abis?: JsonAbisFromAllCalls, submitTxSubscription?: AsyncIterable<GqlSubmitAndAwaitStatusSubscription> | undefined);
    /**
