...
/** @hidden */
export declare function isInputCoin(input: Input): input is InputCoin;
/** @hidden */
export declare function getInputsContract(inputs: Input[]): InputContract[];
/** @hidden */
export declare function aggregateInputsAmountsByAssetAndOwner(inputs: Input[], baseAssetID: string): Map<string, Map<string, BN>>;
/** @hidden */
export declare function getInputFromAssetId(inputs: Input[], assetId: string, isBaseAsset?: boolean): InputCoin | InputMessage | undefined;
/** @hidden */
