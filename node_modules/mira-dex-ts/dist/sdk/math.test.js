...
test('rounding up division', () => {
    ...
    expect(roundingUpDivision(powDecimals(72), powDecimals(12)).toString()).toBe(powDecimals(60).toString());
    expect(roundingUpDivision(powDecimals(72).add(new BN(1)), powDecimals(12)).toString()).toBe(powDecimals(60).add(new BN(1)).toString());
});
