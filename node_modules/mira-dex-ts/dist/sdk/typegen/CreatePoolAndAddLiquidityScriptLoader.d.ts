...
export declare class CreatePoolAndAddLiquidityScriptLoader extends Script<CreatePoolAndAddLiquidityScriptLoaderInputs, CreatePoolAndAddLiquidityScriptLoaderOutput> {
    static readonly abi: {
        programType: string;
        specVersion: string;
