...
var require_dayjs_min = __commonJS({
  "node_modules/@reown/appkit-common/node_modules/dayjs/dayjs.min.js"(exports, module) {
    !function(t2, e2) {
      ...
      "use strict";
      var t2 = 1e3, e2 = 6e4, n2 = 36e5, r2 = "millisecond", i3 = "second", s2 = "minute", u2 = "hour", a2 = "day", o3 = "week", c2 = "month", f6 = "quarter", h4 = "year", d2 = "date", l4 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y4 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M3 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
        ...
        return { M: c2, y: h4, w: o3, d: a2, D: d2, h: u2, m: s2, s: i3, ms: r2, Q: f6 }[t3] || String(t3 || "").toLowerCase().replace(/s$/, "");
      }, u: function(t3) {
        return void 0 === t3;
      } }, g = "en", D = {};
      D[g] = M3;
      ...
      var _ = function() {
        ...
        return m3.parse = function(t3) {
          ...
          var n3, o4 = b.p(t3), f7 = "set" + (this.$u ? "UTC" : ""), l5 = (n3 = {}, n3[a2] = f7 + "Date", n3[d2] = f7 + "Date", n3[c2] = f7 + "Month", n3[h4] = f7 + "FullYear", n3[u2] = f7 + "Hours", n3[s2] = f7 + "Minutes", n3[i3] = f7 + "Seconds", n3[r2] = f7 + "Milliseconds", n3)[o4], $2 = o4 === a2 ? this.$D + (e3 - this.$W) : e3;
          if (o4 === c2 || o4 === h4) {
          ...
          var r3 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i4 = b.z(this), s3 = this.$H, u3 = this.$m, a3 = this.$M, o4 = n3.weekdays, c3 = n3.months, f7 = n3.meridiem, h5 = function(t4, n4, i5, s4) {
            ...
            return r4 || function(t5) {
              switch (t5) {
                ...
                case "MM":
                  return b.s(a3 + 1, 2, "0");
                case "MMM":
                  return h5(n3.monthsShort, a3, c3, 3);
                case "MMMM":
                  return h5(c3, a3);
                case "D":
                  return e3.$D;
                ...
                case "d":
                  return String(e3.$W);
                case "dd":
                  return h5(n3.weekdaysMin, e3.$W, o4, 2);
                case "ddd":
                  return h5(n3.weekdaysShort, e3.$W, o4, 3);
                case "dddd":
                  return o4[e3.$W];
                case "H":
                  return String(s3);
      ...
      return O2.prototype = k2, [["$ms", r2], ["$s", i3], ["$m", s2], ["$H", u2], ["$W", a2], ["$M", c2], ["$y", h4], ["$D", d2]].forEach(function(t3) {
        k2[t3[1]] = function(e3) {
  ...
  "node_modules/@reown/appkit-common/node_modules/dayjs/plugin/relativeTime.js"(exports, module) {
    !function(r2, e2) {
      ...
      return function(r2, e2, t2) {
        r2 = r2 || {};
        var n2 = e2.prototype, o3 = { future: "in %s", past: "%s ago", s: "a few seconds", m: "a minute", mm: "%d minutes", h: "an hour", hh: "%d hours", d: "a day", dd: "%d days", M: "a month", MM: "%d months", y: "a year", yy: "%d years" };
        function i3(r3, e3, t3, o4) {
          return n2.fromToBase(r3, e3, t3, o4);
        }
        t2.en.relativeTime = o3, n2.fromToBase = function(e3, n3, i4, d3, u2) {
          for (var f6, a2, s2, l4 = i4.$locale().relativeTime || o3, h4 = r2.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m2 = h4.length, c2 = 0; c2 < m2; c2 += 1) {
            var y4 = h4[c2];
            ...
            if (s2 = f6 > 0, p <= y4.r || !y4.r) {
              p <= 1 && c2 > 0 && (y4 = h4[c2 - 1]);
              var v = l4[y4.l];
              u2 && (p = u2("" + p)), a2 = "string" == typeof v ? v.replace("%d", p) : v(p, n3, y4.l, s2);
              break;
            }
          }
          if (n3) return a2;
    ...
    !function(e2, n2) {
      ...
      return function(e2, n2, t2) {
        t2.updateLocale = function(e3, n3) {
          var o3 = t2.Ls[e3];
          if (o3) return (n3 ? Object.keys(n3) : []).forEach(function(e4) {
            o3[e4] = n3[e4];
          }), o3;
        };
      };
...
P.div = function(y4) {
  var x = this, Big2 = x.constructor, a2 = x.c, b = (y4 = new Big2(y4)).c, k2 = x.s == y4.s ? 1 : -1, dp = Big2.DP;
  ...
  var bl, bt2, n2, cmp, ri3, bz = b.slice(), ai2 = bl = b.length, al = a2.length, r2 = a2.slice(0, bl), rl = r2.length, q2 = y4, qc2 = q2.c = [], qi2 = 0, p = dp + (q2.e = x.e - y4.e) + 1;
  q2.s = k2;
  k2 = p < 0 ? 0 : p;
  bz.unshift(0);
  for (; rl++ < bl; ) r2.push(0);
...
P.minus = P.sub = function(y4) {
  var i3, j, t2, xlty, x = this, Big2 = x.constructor, a2 = x.s, b = (y4 = new Big2(y4)).s;
  if (a2 != b) {
    y4.s = -b;
    return x.plus(y4);
  }
...
P.mod = function(y4) {
  var ygtx, x = this, Big2 = x.constructor, a2 = x.s, b = (y4 = new Big2(y4)).s;
  if (!y4.c[0]) {
    throw Error(DIV_BY_ZERO);
  }
  x.s = y4.s = 1;
...
P.times = P.mul = function(y4) {
  var c2, x = this, Big2 = x.constructor, xc2 = x.c, yc2 = (y4 = new Big2(y4)).c, a2 = xc2.length, b = yc2.length, i3 = x.e, j = y4.e;
  y4.s = x.s == y4.s ? 1 : -1;
  if (!xc2[0] || !yc2[0]) {
    y4.c = [y4.e = 0];
    return y4;
  ...
  for (c2 = new Array(j = a2 + b); j--; ) c2[j] = 0;
  for (i3 = b; i3--; ) {
    b = 0;
    for (j = a2 + i3; j > i3; ) {
...
var ApiController = {
  ...
  async fetchFeaturedWallets() {
    ...
    if (featuredWalletIds == null ? void 0 : featuredWalletIds.length) {
      ...
      const sortedData = [...data].sort((a2, b) => featuredWalletIds.indexOf(a2.id) - featuredWalletIds.indexOf(b.id));
...
// node_modules/@reown/appkit-controllers/node_modules/@walletconnect/heartbeat/dist/index.es.js
...
function Vi(...t2) {
  ...
  for (let r2 = 0, o3 = 0; r2 < t2.length; r2++) {
    const i3 = t2[r2];
...
for (let t2 = 0, e2 = Jt, n2 = 1, r2 = 0; t2 < 24; t2++) {
  ...
  let o3 = Mi;
  for (let i3 = 0; i3 < 7; i3++) e2 = (e2 << Jt ^ (e2 >> Hi) * Ki) % qi, e2 & Di && (o3 ^= Jt << (Jt << BigInt(i3)) - Jt);
  nr.push(o3);
}
...
function Zi(t2, e2 = 24) {
  ...
  for (let r2 = 24 - e2; r2 < 24; r2++) {
    ...
    for (let s2 = 0; s2 < 10; s2 += 2) {
      const c2 = (s2 + 8) % 10, a2 = (s2 + 2) % 10, u2 = n2[a2], l4 = n2[a2 + 1], f6 = rr(u2, l4, 1) ^ n2[c2], h4 = or(u2, l4, 1) ^ n2[c2 + 1];
      for (let y4 = 0; y4 < 50; y4 += 10) t2[s2 + y4] ^= f6, t2[s2 + y4 + 1] ^= h4;
    }
    let o3 = t2[2], i3 = t2[3];
    for (let s2 = 0; s2 < 24; s2++) {
      const c2 = er[s2], a2 = rr(o3, i3, c2), u2 = or(o3, i3, c2), l4 = tr[s2];
      o3 = t2[l4], i3 = t2[l4 + 1], t2[l4] = a2, t2[l4 + 1] = u2;
    }
...
var En = class _En extends ke {
  constructor(e2, n2, r2, o3 = false, i3 = 24) {
    if (super(), this.blockLen = e2, this.suffix = n2, this.outputLen = r2, this.enableXOF = o3, this.rounds = i3, this.pos = 0, this.posOut = 0, this.finished = false, this.destroyed = false, Wt(r2), 0 >= this.blockLen || this.blockLen >= 200) throw new Error("Sha3 supports only keccak-f1600 function");
  ...
  finish() {
    ...
    this.finished = true;
    const { state: e2, suffix: n2, pos: r2, blockLen: o3 } = this;
    e2[r2] ^= n2, (n2 & 128) !== 0 && r2 === o3 - 1 && this.keccak(), e2[o3 - 1] ^= 128, this.keccak();
  }
  writeInto(e2) {
    ...
    for (let o3 = 0, i3 = e2.length; o3 < i3; ) {
      ...
      e2.set(n2.subarray(this.posOut, this.posOut + s2), o3), this.posOut += s2, o3 += s2;
    }
    return e2;
  }
  xofInto(e2) {
  ...
  _cloneInto(e2) {
    ...
    return e2 || (e2 = new _En(n2, r2, o3, s2, i3)), e2.state32.set(this.state32), e2.pos = this.pos, e2.posOut = this.posOut, e2.finished = this.finished, e2.rounds = i3, e2.suffix = r2, e2.outputLen = o3, e2.enableXOF = s2, e2.destroyed = this.destroyed, e2;
  }
};
...
var Es = (t2, e2) => {
  function n2(r2, ...o3) {
    ...
    return { encrypt(l4, f6) {
      ...
      return a2 = true, tt(l4), c2(s2.encrypt.length, f6), s2.encrypt(l4, f6);
    }, decrypt(l4, f6) {
      if (tt(l4), i3 && l4.length < i3) throw new Error("invalid ciphertext length: smaller than tagLength=" + i3);
      return c2(s2.decrypt.length, f6), s2.decrypt(l4, f6);
    } };
  }
...
function Ir(t2, e2, n2, r2) {
  ...
  const o3 = BigInt(32), i3 = BigInt(4294967295), s2 = Number(n2 >> o3 & i3), c2 = Number(n2 & i3), a2 = r2 ? 4 : 0, u2 = r2 ? 0 : 4;
...
function Is(t2, e2, n2, r2, o3, i3, s2, c2) {
  const a2 = o3.length, u2 = new Uint8Array(ge), l4 = mt(u2), f6 = Ye(o3) && Ye(i3), h4 = f6 ? mt(o3) : Tr, y4 = f6 ? mt(i3) : Tr;
  for (let E2 = 0; E2 < a2; s2++) {
    if (t2(e2, n2, r2, l4, s2, c2), s2 >= Ur) throw new Error("arx: counter overflow");
    const p = Math.min(ge, a2 - E2);
    if (f6 && p === ge) {
      const d2 = E2 / 4;
    ...
    for (let d2 = 0, v; d2 < p; d2++) v = E2 + d2, i3[v] = o3[v] ^ u2[d2];
    E2 += p;
  }
}
function Ns(t2, e2) {
  const { allowShortKeys: n2, extendNonceFn: r2, counterLength: o3, counterRight: i3, rounds: s2 } = ws({ allowShortKeys: false, counterLength: 8, counterRight: false, rounds: 20 }, e2);
  if (typeof t2 != "function") throw new Error("core must be a function");
  return Fe(o3), Fe(s2), Ar(i3), Ar(n2), (c2, a2, u2, l4, f6 = 0) => {
    tt(c2), tt(a2), tt(u2);
    const h4 = u2.length;
...
var Us = class {
  constructor(e2) {
    ...
    const n2 = F(e2, 0), r2 = F(e2, 2), o3 = F(e2, 4), i3 = F(e2, 6), s2 = F(e2, 8), c2 = F(e2, 10), a2 = F(e2, 12), u2 = F(e2, 14);
    this.r[0] = n2 & 8191, this.r[1] = (n2 >>> 13 | r2 << 3) & 8191, this.r[2] = (r2 >>> 10 | o3 << 6) & 7939, this.r[3] = (o3 >>> 7 | i3 << 9) & 8191, this.r[4] = (i3 >>> 4 | s2 << 12) & 255, this.r[5] = s2 >>> 1 & 8190, this.r[6] = (s2 >>> 14 | c2 << 2) & 8191, this.r[7] = (c2 >>> 11 | a2 << 5) & 8065, this.r[8] = (a2 >>> 8 | u2 << 8) & 8191, this.r[9] = u2 >>> 5 & 127;
    for (let l4 = 0; l4 < 8; l4++) this.pad[l4] = F(e2, 16 + 2 * l4);
  }
  process(e2, n2, r2 = false) {
    const o3 = r2 ? 0 : 2048, { h: i3, r: s2 } = this, c2 = s2[0], a2 = s2[1], u2 = s2[2], l4 = s2[3], f6 = s2[4], h4 = s2[5], y4 = s2[6], E2 = s2[7], p = s2[8], d2 = s2[9], v = F(e2, n2 + 0), m2 = F(e2, n2 + 2), O2 = F(e2, n2 + 4), N = F(e2, n2 + 6), $ = F(e2, n2 + 8), B3 = F(e2, n2 + 10), A2 = F(e2, n2 + 12), T = F(e2, n2 + 14);
    let S2 = i3[0] + (v & 8191), L = i3[1] + ((v >>> 13 | m2 << 3) & 8191), U4 = i3[2] + ((m2 >>> 10 | O2 << 6) & 8191), _ = i3[3] + ((O2 >>> 7 | N << 9) & 8191), j = i3[4] + ((N >>> 4 | $ << 12) & 8191), g = i3[5] + ($ >>> 1 & 8191), w = i3[6] + (($ >>> 14 | B3 << 2) & 8191), b = i3[7] + ((B3 >>> 11 | A2 << 5) & 8191), I2 = i3[8] + ((A2 >>> 8 | T << 8) & 8191), R3 = i3[9] + (T >>> 5 | o3), x = 0, C4 = x + S2 * c2 + L * (5 * d2) + U4 * (5 * p) + _ * (5 * E2) + j * (5 * y4);
    x = C4 >>> 13, C4 &= 8191, C4 += g * (5 * h4) + w * (5 * f6) + b * (5 * l4) + I2 * (5 * u2) + R3 * (5 * a2), x += C4 >>> 13, C4 &= 8191;
    let P4 = x + S2 * a2 + L * c2 + U4 * (5 * d2) + _ * (5 * p) + j * (5 * E2);
    x = P4 >>> 13, P4 &= 8191, P4 += g * (5 * y4) + w * (5 * h4) + b * (5 * f6) + I2 * (5 * l4) + R3 * (5 * u2), x += P4 >>> 13, P4 &= 8191;
    let k2 = x + S2 * u2 + L * a2 + U4 * c2 + _ * (5 * d2) + j * (5 * p);
    x = k2 >>> 13, k2 &= 8191, k2 += g * (5 * E2) + w * (5 * y4) + b * (5 * h4) + I2 * (5 * f6) + R3 * (5 * l4), x += k2 >>> 13, k2 &= 8191;
    let M3 = x + S2 * l4 + L * u2 + U4 * a2 + _ * c2 + j * (5 * d2);
    x = M3 >>> 13, M3 &= 8191, M3 += g * (5 * p) + w * (5 * E2) + b * (5 * y4) + I2 * (5 * h4) + R3 * (5 * f6), x += M3 >>> 13, M3 &= 8191;
    let D = x + S2 * f6 + L * l4 + U4 * u2 + _ * a2 + j * c2;
    x = D >>> 13, D &= 8191, D += g * (5 * d2) + w * (5 * p) + b * (5 * E2) + I2 * (5 * y4) + R3 * (5 * h4), x += D >>> 13, D &= 8191;
    let z = x + S2 * h4 + L * f6 + U4 * l4 + _ * u2 + j * a2;
    x = z >>> 13, z &= 8191, z += g * c2 + w * (5 * d2) + b * (5 * p) + I2 * (5 * E2) + R3 * (5 * y4), x += z >>> 13, z &= 8191;
    let Z2 = x + S2 * y4 + L * h4 + U4 * f6 + _ * l4 + j * u2;
    x = Z2 >>> 13, Z2 &= 8191, Z2 += g * a2 + w * c2 + b * (5 * d2) + I2 * (5 * p) + R3 * (5 * E2), x += Z2 >>> 13, Z2 &= 8191;
    let st2 = x + S2 * E2 + L * y4 + U4 * h4 + _ * f6 + j * l4;
    x = st2 >>> 13, st2 &= 8191, st2 += g * u2 + w * a2 + b * c2 + I2 * (5 * d2) + R3 * (5 * p), x += st2 >>> 13, st2 &= 8191;
    let W = x + S2 * p + L * E2 + U4 * y4 + _ * h4 + j * f6;
    x = W >>> 13, W &= 8191, W += g * l4 + w * u2 + b * a2 + I2 * c2 + R3 * (5 * d2), x += W >>> 13, W &= 8191;
    let J2 = x + S2 * d2 + L * p + U4 * E2 + _ * y4 + j * h4;
    x = J2 >>> 13, J2 &= 8191, J2 += g * f6 + w * l4 + b * u2 + I2 * a2 + R3 * c2, x += J2 >>> 13, J2 &= 8191, x = (x << 2) + x | 0, x = x + C4 | 0, C4 = x & 8191, x = x >>> 13, P4 += x, i3[0] = C4, i3[1] = P4, i3[2] = k2, i3[3] = M3, i3[4] = D, i3[5] = z, i3[6] = Z2, i3[7] = st2, i3[8] = W, i3[9] = J2;
  }
  finalize() {
...
function Ts(t2) {
  const e2 = (r2, o3) => t2(o3).update(ze(r2)).digest(), n2 = t2(new Uint8Array(32));
  return e2.outputLen = n2.outputLen, e2.blockLen = n2.blockLen, e2.create = (r2) => t2(r2), e2;
}
var Rs = Ts((t2) => new Us(t2));
function _s(t2, e2, n2, r2, o3, i3 = 20) {
  let s2 = t2[0], c2 = t2[1], a2 = t2[2], u2 = t2[3], l4 = e2[0], f6 = e2[1], h4 = e2[2], y4 = e2[3], E2 = e2[4], p = e2[5], d2 = e2[6], v = e2[7], m2 = o3, O2 = n2[0], N = n2[1], $ = n2[2], B3 = s2, A2 = c2, T = a2, S2 = u2, L = l4, U4 = f6, _ = h4, j = y4, g = E2, w = p, b = d2, I2 = v, R3 = m2, x = O2, C4 = N, P4 = $;
  ...
  let k2 = 0;
  r2[k2++] = s2 + B3 | 0, r2[k2++] = c2 + A2 | 0, r2[k2++] = a2 + T | 0, r2[k2++] = u2 + S2 | 0, r2[k2++] = l4 + L | 0, r2[k2++] = f6 + U4 | 0, r2[k2++] = h4 + _ | 0, r2[k2++] = y4 + j | 0, r2[k2++] = E2 + g | 0, r2[k2++] = p + w | 0, r2[k2++] = d2 + b | 0, r2[k2++] = v + I2 | 0, r2[k2++] = m2 + R3 | 0, r2[k2++] = O2 + x | 0, r2[k2++] = N + C4 | 0, r2[k2++] = $ + P4 | 0;
}
...
function _r(t2, e2, n2, r2, o3) {
  const i3 = t2(e2, n2, js), s2 = Rs.create(i3);
  o3 && Rr(s2, o3), Rr(s2, r2);
  const c2 = new Uint8Array(16), a2 = gs(c2);
  Ir(a2, 0, BigInt(o3 ? o3.length : 0), true), Ir(a2, 8, BigInt(r2.length), true), s2.update(c2);
  const u2 = s2.digest();
  return jt(i3, c2), u2;
}
var Cs = (t2) => (e2, n2, r2) => ({ encrypt(i3, s2) {
  ...
  t2(e2, n2, a2, a2, 1);
  const u2 = _r(t2, e2, n2, a2, r2);
  return s2.set(u2, c2), jt(u2), s2;
}, decrypt(i3, s2) {
  s2 = Br(i3.length - 16, s2, false);
  const c2 = i3.subarray(0, -16), a2 = i3.subarray(-16), u2 = _r(t2, e2, n2, c2, r2);
...
var Lr = class extends ke {
  ...
  _cloneInto(e2) {
    ...
    const { oHash: n2, iHash: r2, finished: o3, destroyed: i3, blockLen: s2, outputLen: c2 } = this;
    return e2 = e2, e2.finished = o3, e2.destroyed = i3, e2.blockLen = s2, e2.outputLen = c2, e2.oHash = n2._cloneInto(e2.oHash), e2.iHash = r2._cloneInto(e2.iHash), e2;
  }
  destroy() {
...
var qs = class extends ke {
  constructor(e2, n2, r2, o3) {
    super(), this.blockLen = e2, this.outputLen = n2, this.padOffset = r2, this.isLE = o3, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e2), this.view = Pe(this.buffer);
  }
  update(e2) {
    Rt(this);
    ...
    for (let s2 = 0; s2 < i3; ) {
      ...
      r2.set(e2.subarray(s2, s2 + c2), this.pos), this.pos += c2, s2 += c2, this.pos === o3 && (this.process(n2, 0), this.pos = 0);
    }
  ...
  _cloneInto(e2) {
    ...
    const { blockLen: n2, buffer: r2, length: o3, finished: i3, destroyed: s2, pos: c2 } = this;
    return e2.length = o3, e2.pos = c2, e2.finished = i3, e2.destroyed = s2, o3 % n2 && e2.buffer.set(r2), e2;
  }
};
...
var Fs = class extends qs {
  ...
  get() {
    const { A: e2, B: n2, C: r2, D: o3, E: i3, F: s2, G: c2, H: a2 } = this;
    return [e2, n2, r2, o3, i3, s2, c2, a2];
  }
  set(e2, n2, r2, o3, i3, s2, c2, a2) {
    this.A = e2 | 0, this.B = n2 | 0, this.C = r2 | 0, this.D = o3 | 0, this.E = i3 | 0, this.F = s2 | 0, this.G = c2 | 0, this.H = a2 | 0;
  }
  process(e2, n2) {
    ...
    let { A: r2, B: o3, C: i3, D: s2, E: c2, F: a2, G: u2, H: l4 } = this;
    for (let f6 = 0; f6 < 64; f6++) {
      const h4 = ct(c2, 6) ^ ct(c2, 11) ^ ct(c2, 25), y4 = l4 + h4 + Ds(c2, a2, u2) + Ks[f6] + bt[f6] | 0, p = (ct(r2, 2) ^ ct(r2, 13) ^ ct(r2, 22)) + Hs(r2, o3, i3) | 0;
      l4 = u2, u2 = a2, a2 = c2, c2 = s2 + y4 | 0, s2 = i3, i3 = o3, o3 = r2, r2 = y4 + p | 0;
    }
    r2 = r2 + this.A | 0, o3 = o3 + this.B | 0, i3 = i3 + this.C | 0, s2 = s2 + this.D | 0, c2 = c2 + this.E | 0, a2 = a2 + this.F | 0, u2 = u2 + this.G | 0, l4 = l4 + this.H | 0, this.set(r2, o3, i3, s2, c2, a2, u2, l4);
  }
  roundClean() {
    bt.fill(0);
  }
...
function et(t2, e2, n2) {
  ...
  const o3 = r2.length;
  if (typeof n2 == "number" && o3 !== n2) throw new Error(t2 + " of length " + n2 + " expected, got " + o3);
  return r2;
}
function ne(...t2) {
  let e2 = 0;
...
function Vr(t2, e2, n2) {
  ...
  let r2 = Qe(t2), o3 = Qe(t2), i3 = 0;
  const s2 = () => {
    r2.fill(1), o3.fill(0), i3 = 0;
  }, c2 = (...f6) => n2(o3, r2, ...f6), a2 = (f6 = Qe()) => {
    o3 = c2(kr([0]), f6), r2 = c2(), f6.length !== 0 && (o3 = c2(kr([1]), f6), r2 = c2());
  }, u2 = () => {
...
function Dt(t2, e2, n2 = {}) {
  const r2 = (o3, i3, s2) => {
    ...
    const a2 = t2[o3];
    if (!(s2 && a2 === void 0) && !c2(a2, t2)) throw new Error("param " + String(o3) + " is invalid. Expected " + i3 + ", got " + a2);
  };
...
function nn(t2, e2) {
  ...
  let n2 = X(t2, e2), r2 = e2, o3 = q, i3 = H;
  for (; n2 !== q; ) {
    const c2 = r2 / n2, a2 = r2 % n2, u2 = o3 - i3 * c2;
    r2 = n2, n2 = a2, o3 = i3, i3 = u2;
  }
...
function rc(t2) {
  ...
  if (r2 === 1) {
    ...
    return function(a2, u2) {
      const l4 = a2.pow(u2, s2);
      if (!a2.eql(a2.sqr(l4), u2)) throw new Error("Cannot find square root");
      return l4;
    };
  }
  const i3 = (n2 + H) / At;
  return function(c2, a2) {
    ...
    let u2 = r2, l4 = c2.pow(c2.mul(c2.ONE, o3), n2), f6 = c2.pow(a2, i3), h4 = c2.pow(a2, n2);
    for (; !c2.eql(h4, c2.ONE); ) {
      if (c2.eql(h4, c2.ZERO)) return c2.ZERO;
      let y4 = 1;
      for (let p = c2.sqr(h4); y4 < u2 && !c2.eql(p, c2.ONE); y4++) p = c2.sqr(p);
      const E2 = c2.pow(l4, H << BigInt(u2 - y4 - 1));
      l4 = c2.sqr(E2), f6 = c2.mul(f6, E2), h4 = c2.mul(h4, l4), u2 = y4;
    }
    return f6;
  };
}
function oc(t2) {
  ...
  if (t2 % Dr === Mr) {
    const e2 = (t2 - Mr) / Dr;
    return function(r2, o3) {
      const i3 = r2.mul(o3, At), s2 = r2.pow(i3, e2), c2 = r2.mul(o3, s2), a2 = r2.mul(r2.mul(c2, At), s2), u2 = r2.mul(c2, r2.sub(a2, r2.ONE));
...
function sc(t2) {
  const e2 = { ORDER: "bigint", MASK: "bigint", BYTES: "isSafeInteger", BITS: "isSafeInteger" }, n2 = ic.reduce((r2, o3) => (r2[o3] = "function", r2), e2);
  return Dt(t2, n2);
}
function cc(t2, e2, n2) {
  ...
  if (n2 === H) return e2;
  let r2 = t2.ONE, o3 = e2;
  for (; n2 > q; ) n2 & H && (r2 = t2.mul(r2, o3)), o3 = t2.sqr(o3), n2 >>= H;
  return r2;
}
function ac(t2, e2) {
  const n2 = new Array(e2.length), r2 = e2.reduce((i3, s2, c2) => t2.is0(s2) ? i3 : (n2[c2] = i3, t2.mul(i3, s2)), t2.ONE), o3 = t2.inv(r2);
  return e2.reduceRight((i3, s2, c2) => t2.is0(s2) ? i3 : (n2[c2] = t2.mul(i3, n2[c2]), t2.mul(i3, s2)), o3), n2;
}
function qr(t2, e2) {
...
function Kr2(t2, e2, n2 = false, r2 = {}) {
  ...
  const { nBitLength: o3, nByteLength: i3 } = qr(t2, e2);
  if (i3 > 2048) throw new Error("invalid field: expected ORDER of <= 2048 bytes");
  let s2;
  const c2 = Object.freeze({ ORDER: t2, isLE: n2, BITS: o3, BYTES: i3, MASK: Je(o3), ZERO: q, ONE: H, create: (a2) => X(a2, t2), isValid: (a2) => {
    if (typeof a2 != "bigint") throw new Error("invalid field element: expected bigint, got " + typeof a2);
    return q <= a2 && a2 < t2;
  }, is0: (a2) => a2 === q, isOdd: (a2) => (a2 & H) === H, neg: (a2) => X(-a2, t2), eql: (a2, u2) => a2 === u2, sqr: (a2) => X(a2 * a2, t2), add: (a2, u2) => X(a2 + u2, t2), sub: (a2, u2) => X(a2 - u2, t2), mul: (a2, u2) => X(a2 * u2, t2), pow: (a2, u2) => cc(c2, a2, u2), div: (a2, u2) => X(a2 * nn(u2, t2), t2), sqrN: (a2) => a2 * a2, addN: (a2, u2) => a2 + u2, subN: (a2, u2) => a2 - u2, mulN: (a2, u2) => a2 * u2, inv: (a2) => nn(a2, t2), sqrt: r2.sqrt || ((a2) => (s2 || (s2 = oc(t2)), s2(c2, a2))), invertBatch: (a2) => ac(c2, a2), cmov: (a2, u2, l4) => l4 ? u2 : a2, toBytes: (a2) => n2 ? be(a2, i3) : Mt(a2, i3), fromBytes: (a2) => {
...
function dc(t2, e2) {
  return { constTimeNegate: rn, hasPrecomputes(n2) {
    return cn(n2) !== 1;
  }, unsafeLadder(n2, r2, o3 = t2.ZERO) {
    let i3 = n2;
    for (; r2 > Zr; ) r2 & ve && (o3 = o3.add(i3)), i3 = i3.double(), r2 >>= ve;
    return o3;
  }, precomputeWindow(n2, r2) {
    const { windows: o3, windowSize: i3 } = on(r2, e2), s2 = [];
    let c2 = n2, a2 = c2;
    for (let u2 = 0; u2 < o3; u2++) {
      a2 = c2, s2.push(a2);
      for (let l4 = 1; l4 < i3; l4++) a2 = a2.add(c2), s2.push(a2);
      c2 = a2.double();
    }
    return s2;
  }, wNAF(n2, r2, o3) {
    ...
    for (let h4 = 0; h4 < i3; h4++) {
      const y4 = h4 * s2;
      let E2 = Number(o3 & u2);
      o3 >>= f6, E2 > s2 && (E2 -= l4, o3 += ve);
      const p = y4, d2 = y4 + Math.abs(E2) - 1, v = h4 % 2 !== 0, m2 = E2 < 0;
      E2 === 0 ? a2 = a2.add(rn(v, r2[p])) : c2 = c2.add(rn(m2, r2[d2]));
    }
    return { p: c2, f: a2 };
  }, wNAFUnsafe(n2, r2, o3, i3 = t2.ZERO) {
    const { windows: s2, windowSize: c2 } = on(n2, e2), a2 = BigInt(2 ** n2 - 1), u2 = 2 ** n2, l4 = BigInt(n2);
    for (let f6 = 0; f6 < s2; f6++) {
      const h4 = f6 * c2;
      if (o3 === Zr) break;
      let y4 = Number(o3 & a2);
      if (o3 >>= l4, y4 > c2 && (y4 -= u2, o3 += ve), y4 === 0) continue;
    ...
    let i3 = sn2.get(r2);
    return i3 || (i3 = this.precomputeWindow(r2, n2), n2 !== 1 && sn2.set(r2, o3(i3))), i3;
  }, wNAFCached(n2, r2, o3) {
    const i3 = cn(n2);
...
function hc(t2, e2, n2, r2) {
  ...
  const o3 = t2.ZERO, i3 = Pr(BigInt(n2.length)), s2 = i3 > 12 ? i3 - 3 : i3 > 4 ? i3 - 2 : i3 ? 2 : 1, c2 = (1 << s2) - 1, a2 = new Array(c2 + 1).fill(o3), u2 = Math.floor((e2.BITS - 1) / s2) * s2;
  let l4 = o3;
  for (let f6 = u2; f6 >= 0; f6 -= s2) {
    ...
    let h4 = o3;
    for (let y4 = a2.length - 1, E2 = o3; y4 > 0; y4--) E2 = E2.add(a2[y4]), h4 = h4.add(E2);
...
function gc(t2) {
  const e2 = pc(t2), { P: n2 } = e2, r2 = (m2) => X(m2, n2), o3 = e2.montgomeryBits, i3 = Math.ceil(o3 / 8), s2 = e2.nByteLength, c2 = e2.adjustScalarBytes || ((m2) => m2), a2 = e2.powPminus2 || ((m2) => Hr(m2, n2 - BigInt(2), n2));
  function u2(m2, O2, N) {
    const $ = r2(m2 * (O2 - N));
...
BigInt(8);
function bc(t2) {
  const e2 = BigInt(10), n2 = BigInt(20), r2 = BigInt(40), o3 = BigInt(80), i3 = un, c2 = t2 * t2 % i3 * t2 % i3, a2 = it(c2, Xr, i3) * c2 % i3, u2 = it(a2, yc, i3) * t2 % i3, l4 = it(u2, wc, i3) * u2 % i3, f6 = it(l4, e2, i3) * l4 % i3, h4 = it(f6, n2, i3) * f6 % i3, y4 = it(h4, r2, i3) * h4 % i3, E2 = it(y4, o3, i3) * y4 % i3, p = it(E2, o3, i3) * y4 % i3, d2 = it(p, e2, i3) * l4 % i3;
...
var lt = { Err: Oc, _tlv: { encode: (t2, e2) => {
  ...
  const r2 = e2.length / 2, o3 = kt(r2);
  if (o3.length / 2 & 128) throw new n2("tlv.encode: long form length too big");
  const i3 = r2 > 127 ? kt(o3.length / 2 | 128) : "";
  return kt(t2) + i3 + o3 + e2;
}, decode(t2, e2) {
  const { Err: n2 } = lt;
  let r2 = 0;
  if (t2 < 0 || t2 > 256) throw new n2("tlv.encode: wrong tag");
  ...
  const { Err: e2, _int: n2, _tlv: r2 } = lt, o3 = typeof t2 == "string" ? Sc(t2) : t2;
  te(o3);
  const { v: i3, l: s2 } = r2.decode(48, o3);
  if (s2.length) throw new e2("invalid signature: left bytes after parsing");
  const { v: c2, l: a2 } = r2.decode(2, i3), { v: u2, l: l4 } = r2.decode(2, a2);
  if (l4.length) throw new e2("invalid signature: left bytes after parsing");
  return { r: n2.decode(c2), s: n2.decode(u2) };
}, hexFromSig(t2) {
  const { _tlv: e2, _int: n2 } = lt, r2 = e2.encode(2, n2.encode(t2.r)), o3 = e2.encode(2, n2.encode(t2.s)), i3 = r2 + o3;
...
BigInt(4);
function Ac(t2) {
  const e2 = vc(t2), { Fp: n2 } = e2, r2 = Kr2(e2.n, e2.nBitLength), o3 = e2.toBytes || ((p, d2, v) => {
  ...
  class h4 {
    ...
    toRawBytes(d2 = true) {
      return Ct("isCompressed", d2), this.assertValidity(), o3(h4, this, d2);
    }
    toHex(d2 = true) {
...
function Ic(t2) {
  const e2 = Bc(t2), { Fp: n2, n: r2 } = e2, o3 = n2.BYTES + 1, i3 = 2 * n2.BYTES + 1;
  function s2(g) {
    return X(g, r2);
  }
  function c2(g) {
  ...
  const { ProjectivePoint: a2, normPrivateKeyToScalar: u2, weierstrassEquation: l4, isWithinCurveOrder: f6 } = Ac({ ...e2, toBytes(g, w, b) {
  ...
  class d2 {
    ...
    recoverPublicKey(w) {
      ...
      const P4 = (R3 & 1) === 0 ? "02" : "03", k2 = a2.fromHex(P4 + h4(C4)), M3 = c2(C4), D = s2(-x * M3), z = s2(I2 * M3), Z2 = a2.BASE.multiplyAndAddUnsafe(k2, D, z);
  ...
  }, precompute(g = 8, w = a2.BASE) {
    return w._setWindowSize(g), w.multiply(BigInt(3)), w;
  } };
  function m2(g, w = true) {
    return a2.fromPrivateKey(g).toRawBytes(w);
  }
  function O2(g) {
    const w = St(g), b = typeof g == "string", I2 = (w || b) && g.length;
    return w ? I2 === o3 || I2 === i3 : b ? I2 === 2 * o3 || I2 === 2 * i3 : g instanceof a2;
  }
  function N(g, w, b = true) {
    ...
    return a2.fromHex(w).multiply(u2(g)).toRawBytes(b);
  }
  ...
  function S2(g, w, b = L) {
    ...
    function st2(W) {
      const J2 = $(W);
      if (!f6(J2)) return;
      const Be3 = c2(J2), zt = a2.BASE.multiply(J2).toAffine(), vt = s2(zt.x);
      if (vt === dt) return;
  ...
  function j(g, w, b, I2 = U4) {
    ...
    C4 && (w = e2.hash(w));
    const { r: Z2, s: st2 } = D, W = B3(w), J2 = c2(st2), Be3 = s2(W * J2), zt = s2(Z2 * J2), vt = (_a = a2.BASE.multiplyAndAddUnsafe(z, Be3, zt)) == null ? void 0 : _a.toAffine();
    return vt ? s2(vt.x) === Z2 : false;
  }
  return { CURVE: e2, getPublicKey: m2, getSharedSecret: N, sign: _, verify: j, ProjectivePoint: a2, Signature: d2, utils: v };
}
function Nc(t2) {
...
function rr2(r2, e2) {
  ...
  for (var s2 = 0; s2 < r2.length; s2++) {
    ...
    if (t2[o3] !== 255) throw new TypeError(n2 + " is ambiguous");
    t2[o3] = s2;
  }
  var a2 = r2.length, c2 = r2.charAt(0), h4 = Math.log(a2) / Math.log(256), l4 = Math.log(256) / Math.log(a2);
  function d2(u2) {
    ...
    for (var j = (D - I2) * l4 + 1 >>> 0, T = new Uint8Array(j); I2 !== D; ) {
      for (var q2 = u2[I2], J2 = 0, K2 = j - 1; (q2 !== 0 || J2 < x) && K2 !== -1; K2--, J2++) q2 += 256 * T[K2] >>> 0, T[K2] = q2 % a2 >>> 0, q2 = q2 / a2 >>> 0;
  ...
  function g(u2) {
    ...
    if (u2[b] !== " ") {
      ...
      for (var D = (u2.length - b) * h4 + 1 >>> 0, j = new Uint8Array(D); u2[b]; ) {
        ...
        if (T === 255) return;
        for (var q2 = 0, J2 = D - 1; (T !== 0 || q2 < I2) && J2 !== -1; J2--, q2++) T += a2 * j[J2] >>> 0, j[J2] = T % 256 >>> 0, T = T / 256 >>> 0;
...
var gr = (r2, e2, t2, i3) => {
  ...
  let n2 = r2.length;
  for (; r2[n2 - 1] === "="; ) --n2;
  const o3 = new Uint8Array(n2 * t2 / 8 | 0);
  let a2 = 0, c2 = 0, h4 = 0;
  for (let l4 = 0; l4 < n2; ++l4) {
    const d2 = s2[r2[l4]];
    if (d2 === void 0) throw new SyntaxError(`Non-${i3} character`);
    c2 = c2 << t2 | d2, a2 += t2, a2 >= 8 && (a2 -= 8, o3[h4++] = 255 & c2 >> a2);
  }
...
var pr = (r2, e2, t2) => {
  ...
  let n2 = "", o3 = 0, a2 = 0;
  for (let c2 = 0; c2 < r2.length; ++c2) for (a2 = a2 << 8 | r2[c2], o3 += 8; o3 > t2; ) o3 -= t2, n2 += e2[s2 & a2 >> o3];
  if (o3 && (n2 += e2[s2 & a2 << t2 - o3]), i3) for (; n2.length * t2 & 7; ) n2 += "=";
  return n2;
};
...
var ci = 127;
function Me(r2, i3) {
  var t2 = 0, i3 = i3 || 0, s2 = 0, n2 = i3, o3, a2 = r2.length;
  do {
    if (n2 >= a2) throw Me.bytes = 0, new RangeError("Could not decode varint");
    o3 = r2[n2++], t2 += s2 < 28 ? (o3 & ci) << s2 : (o3 & ci) * Math.pow(2, s2), s2 += 7;
  } while (o3 >= nn2);
...
*/
//# sourceMappingURL=chunk-JHUEOG66.js.map
