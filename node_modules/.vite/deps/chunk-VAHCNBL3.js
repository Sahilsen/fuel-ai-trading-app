...
var NetworkController = {
  ...
  checkIfSupportedNetwork() {
    var _a2;
    state9.isUnsupportedChain = !((_a2 = state9.requestedCaipNetworks) == null ? void 0 : _a2.some((network) => {
      var _a3;
      return network.id === ((_a3 = state9.caipNetwork) == null ? void 0 : _a3.id);
    }));
  ...
  checkIfSmartAccountEnabled() {
    var _a2, _b;
    const networkId = NetworkUtil.caipNetworkIdToNumber((_a2 = state9.caipNetwork) == null ? void 0 : _a2.id);
    if (!networkId) {
      return false;
    }
    return Boolean((_b = state9.smartAccountEnabledNetworks) == null ? void 0 : _b.includes(networkId));
  },
  resetNetwork() {
...
var SwapController = {
  ...
  getParams() {
    ...
    const invalidToToken = !((_b = state12.toToken) == null ? void 0 : _b.address) || !((_c = state12.toToken) == null ? void 0 : _c.decimals);
  ...
  resetValues() {
    ...
    const networkToken = (_a2 = state12.tokens) == null ? void 0 : _a2.find((token) => token.address === networkAddress);
  ...
  async sendTransactionForSwap(data) {
    ...
    const snackbarPendingMessage = `Swapping ${(_a2 = state12.sourceToken) == null ? void 0 : _a2.symbol} to ${NumberUtil.formatNumberToLocalString(toTokenAmount, 3)} ${(_b = state12.toToken) == null ? void 0 : _b.symbol}`;
...
use-sync-external-store/cjs/use-sync-external-store-shim.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-VAHCNBL3.js.map
