...
async function processDataProtocolResponse({
  ...
  onToolCall,
  onFinish,
  generateId: generateId23 = generateId,
  ...
  for await (const { type, value } of readDataStream(reader, {
    ...
    if (type === "tool_call_streaming_start") {
      ...
      prefixMap.text.internalUpdateId = generateId23();
      ...
      const toolInvocations = (_a17 = prefixMap.text) == null ? void 0 : _a17.toolInvocations;
...
var APICallError2 = class extends AISDKError2 {
  ...
  static isAPICallError(error) {
    return error instanceof Error && error.name === name14 && typeof error.url === "string" && typeof error.requestBodyValues === "object" && (error.statusCode == null || typeof error.statusCode === "number") && (error.responseHeaders == null || typeof error.responseHeaders === "object") && (error.responseBody == null || typeof error.responseBody === "string") && (error.cause == null || typeof error.cause === "object") && typeof error.isRetryable === "boolean" && (error.data == null || typeof error.data === "object");
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var EmptyResponseBodyError2 = class extends AISDKError2 {
  ...
  static isEmptyResponseBodyError(error) {
    return error instanceof Error && error.name === name22;
  }
};
_a32 = symbol32;
...
var InvalidPromptError = class extends AISDKError2 {
  ...
  static isInvalidPromptError(error) {
    return error instanceof Error && error.name === name42 && prompt != null;
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var InvalidResponseDataError = class extends AISDKError2 {
  ...
  static isInvalidResponseDataError(error) {
    return error instanceof Error && error.name === name52 && error.data != null;
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
Error message: ${getErrorMessage(cause)}`,
  ...
  static isJSONParseError(error) {
    return error instanceof Error && error.name === name62 && "text" in error && typeof error.text === "string";
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var NoContentGeneratedError = class extends AISDKError2 {
  ...
  static isNoContentGeneratedError(error) {
    return error instanceof Error && error.name === name92;
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var NoSuchModelError = class extends AISDKError2 {
  ...
  static isNoSuchModelError(error) {
    return error instanceof Error && error.name === name102 && typeof error.modelId === "string" && typeof error.modelType === "string";
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
Error message: ${getErrorMessage(cause)}`,
  ...
  static isTypeValidationError(error) {
    return error instanceof Error && error.name === name122;
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var UnsupportedFunctionalityError = class extends AISDKError2 {
  ...
  static isUnsupportedFunctionalityError(error) {
    return error instanceof Error && error.name === name132 && typeof error.functionality === "string";
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var __export = (target, all) => {
  for (var name113 in all)
    __defProp(target, name113, { get: all[name113], enumerable: true });
};
...
var RetryError = class extends AISDKError2 {
  ...
  static isRetryError(error) {
    return error instanceof Error && error.name === name15 && typeof error.reason === "string" && Array.isArray(error.errors);
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
        ...
        () => (
          ...
          recordSpan({
            ...
            fn: async (doEmbedSpan) => {
              ...
              const usage2 = (_a113 = modelResponse.usage) != null ? _a113 : { tokens: NaN };
...
var DownloadError = class extends AISDKError2 {
  constructor({
    ...
    super({ name: name23, message, cause });
    this[_a23] = true;
    this.url = url;
    this.statusCode = statusCode;
  ...
  static isDownloadError(error) {
    return error instanceof Error && error.name === name23 && typeof error.url === "string" && (error.statusCode == null || typeof error.statusCode === "number") && (error.statusText == null || typeof error.statusText === "string");
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
async function download({
  ...
  try {
    ...
    return {
      ...
      mimeType: (_a113 = response.headers.get("content-type")) != null ? _a113 : void 0
    };
  } catch (error) {
...
var name33 = "AI_InvalidDataContentError";
...
var InvalidDataContentError = class extends AISDKError2 {
  ...
  static isInvalidDataContentError(error) {
    return error instanceof Error && error.name === name33 && error.content != null;
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var name43 = "AI_InvalidMessageRoleError";
...
var InvalidMessageRoleError = class extends AISDKError2 {
  ...
  static isInvalidMessageRoleError(error) {
    return error instanceof Error && error.name === name43 && typeof error.role === "string";
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var name53 = "AI_InvalidArgumentError";
...
var InvalidArgumentError3 = class extends AISDKError2 {
  ...
  static isInvalidArgumentError(error) {
    return error instanceof Error && error.name === name53 && typeof error.parameter === "string" && typeof error.value === "string";
  }
  toJSON() {
    return {
      name: this.name,
...
var name63 = "AI_MessageConversionError";
...
function convertToCoreMessages(messages, options) {
  var _a113;
  const tools = (_a113 = options == null ? void 0 : options.tools) != null ? _a113 : {};
  const coreMessages = [];
...
var NoObjectGeneratedError = class extends AISDKError2 {
  ...
  static isNoObjectGeneratedError(error) {
    return error instanceof Error && error.name === name73;
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var arrayOutputStrategy = (schema) => {
  ...
  return {
    ...
    validatePartialResult({ value, latestObject, isFirstDelta, isFinalDelta }) {
      ...
      const publishedElementCount = (_a113 = latestObject == null ? void 0 : latestObject.length) != null ? _a113 : 0;
      let textDelta = "";
      if (isFirstDelta) {
        textDelta += "[";
      }
    ...
    fn: async (span) => {
      ...
      switch (mode) {
        case "json": {
          ...
          const generateResult = await retry(
            () => recordSpan({
              ...
              fn: async (span2) => {
                ...
                const responseData = {
                  id: (_b2 = (_a123 = result2.response) == null ? void 0 : _a123.id) != null ? _b2 : generateId3(),
          ...
          request = (_a113 = generateResult.request) != null ? _a113 : {};
        ...
        case "tool": {
          ...
          const generateResult = await retry(
            () => recordSpan({
              ...
              tracer,
              fn: async (span2) => {
                var _a123, _b2, _c, _d, _e, _f, _g, _h;
                const result2 = await model.doGenerate({
                  mode: {
                    type: "object-tool",
                    tool: {
                ...
                const objectText = (_b2 = (_a123 = result2.toolCalls) == null ? void 0 : _a123[0]) == null ? void 0 : _b2.args;
...
var DelayedPromise = class {
  ...
  resolve(value) {
    ...
    if (this.promise) {
      (_a113 = this._resolve) == null ? void 0 : _a113.call(this, value);
    }
  }
  reject(error) {
    var _a113;
    ...
    if (this.promise) {
      (_a113 = this._reject) == null ? void 0 : _a113.call(this, error);
    }
  }
};
function now() {
      ...
      new TransformStream({
        async transform(chunk, controller) {
          ...
          switch (chunk.type) {
            case "response-metadata": {
              response = {
                id: (_a113 = chunk.id) != null ? _a113 : response.id,
...
var name83 = "AI_InvalidToolArgumentsError";
...
var InvalidToolArgumentsError = class extends AISDKError2 {
  ...
  static isInvalidToolArgumentsError(error) {
    return error instanceof Error && error.name === name83 && typeof error.toolName === "string" && typeof error.toolArgs === "string";
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var NoSuchToolError = class extends AISDKError2 {
  ...
  static isNoSuchToolError(error) {
    return error instanceof Error && error.name === name93 && "toolName" in error && error.toolName != void 0 && typeof error.name === "string";
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var originalGenerateId3 = createIdGenerator2({ prefix: "aitxt", size: 24 });
  ...
  return recordSpan({
    ...
    fn: async (span) => {
      ...
      do {
        ...
        currentModelResponse = await retry(
          () => recordSpan({
            ...
            attributes: selectTelemetryAttributes({
              ...
              attributes: {
                ...
                "ai.prompt.tools": {
                  ...
                  input: () => {
                    var _a123;
                    return (_a123 = mode.tools) == null ? void 0 : _a123.map((tool2) => JSON.stringify(tool2));
                  }
                },
            ...
            fn: async (span2) => {
              ...
              const responseData = {
                id: (_b2 = (_a123 = result.response) == null ? void 0 : _a123.id) != null ? _b2 : generateId3(),
        ...
        currentToolCalls = ((_a113 = currentModelResponse.toolCalls) != null ? _a113 : []).map(
...
var originalGenerateId4 = createIdGenerator2({ prefix: "aitxt", size: 24 });
...
var name103 = "AI_NoSuchProviderError";
...
var NoSuchProviderError = class extends NoSuchModelError {
  constructor({
    ...
    super({ errorName: name103, modelId, modelType, message });
    this[_a103] = true;
  ...
  static isNoSuchProviderError(error) {
    return error instanceof Error && error.name === name103 && typeof error.providerId === "string" && Array.isArray(error.availableProviders);
  }
  /**
   * @deprecated Do not use this method. It will be removed in the next major version.
   */
...
var DefaultProviderRegistry = class {
  ...
  languageModel(id) {
    ...
    const model = (_b = (_a113 = this.getProvider(providerId)).languageModel) == null ? void 0 : _b.call(_a113, modelId);
    if (model == null) {
  ...
  textEmbeddingModel(id) {
    ...
    const model = (_c = (_a113 = provider.textEmbeddingModel) == null ? void 0 : _a113.call(provider, modelId)) != null ? _c : "textEmbedding" in provider ? (_b = provider.textEmbedding) == null ? void 0 : _b.call(provider, modelId) : void 0;
    if (model == null) {
      throw new NoSuchModelError({
        modelId: id,
...
function readableFromAsyncIterable(iterable) {
  ...
  return new ReadableStream({
    ...
    async cancel(reason) {
      var _a113;
      await ((_a113 = it.return) == null ? void 0 : _a113.call(it, reason));
    }
  });
}
  ...
  const stream = new ReadableStream({
    async start(controller) {
        ...
        for await (const value of stream2) {
          switch (value.event) {
            ...
            case "thread.message.delta": {
              const content = (_a123 = value.data.delta.content) == null ? void 0 : _a123[0];
      ...
      try {
        ...
        sendError((_a113 = error.message) != null ? _a113 : `${error}`);
      } finally {
        controller.close();
      }
    },
...
async function* asDeltaIterable(response, extractTextDeltaFromChunk) {
  var _a113, _b;
  const decoder = new TextDecoder();
  for await (const chunk of (_a113 = response.body) != null ? _a113 : []) {
...
function AWSBedrockAnthropicMessagesStream(response, callbacks) {
  return AWSBedrockStream(response, callbacks, (chunk) => {
    var _a113;
    return (_a113 = chunk.delta) == null ? void 0 : _a113.text;
  });
}
...
function createParser2(res) {
  var _a113;
  const reader = (_a113 = res.body) == null ? void 0 : _a113.getReader();
  return new ReadableStream({
    async start(controller) {
      if (!reader) {
        controller.close();
...
async function* streamable3(response) {
  ...
  for await (const chunk of response.stream) {
    const parts = (_c = (_b = (_a113 = chunk.candidates) == null ? void 0 : _a113[0]) == null ? void 0 : _b.content) == null ? void 0 : _c.parts;
    if (parts === void 0) {
      continue;
    }
...
function createParser3(res) {
  ...
  return new ReadableStream({
    async pull(controller) {
      ...
      const text = trimStartOfStream((_b = (_a113 = value.token) == null ? void 0 : _a113.text) != null ? _b : "");
      if (!text)
        return;
...
function InkeepStream(res, callbacks) {
  ...
  const inkeepEventParser = (data, options) => {
    ...
    if (event === "records_cited") {
      ...
      (_a113 = callbacks == null ? void 0 : callbacks.onRecordsCited) == null ? void 0 : _a113.call(callbacks, records_cited);
    }
  ...
  passThroughCallbacks = {
    ...
    onFinal: (completion) => {
      ...
      (_a113 = callbacks == null ? void 0 : callbacks.onFinal) == null ? void 0 : _a113.call(callbacks, completion, inkeepOnFinalMetadata);
    }
  };
...
async function* streamable4(stream) {
  var _a113, _b;
  for await (const chunk of stream) {
    const content = (_b = (_a113 = chunk.choices[0]) == null ? void 0 : _a113.delta) == null ? void 0 : _b.content;
    ...
    if ("promptFilterResults" in chunk) {
      chunk = {
        ...
        choices: chunk.choices.map((choice) => {
          var _a113, _b, _c, _d, _e, _f, _g;
          return {
            delta: {
              content: (_a113 = choice.delta) == null ? void 0 : _a113.content,
...
function chunkToText() {
  ...
  return (json) => {
    var _a113, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r;
    if (isChatCompletionChunk(json)) {
      const delta = (_a113 = json.choices[0]) == null ? void 0 : _a113.delta;
...
async function ReplicateStream(res, cb, options) {
  var _a113;
  const url = (_a113 = res.urls) == null ? void 0 : _a113.stream;
  if (!url) {
    if (res.error)
...
function streamToResponse(res, response, init, data) {
  var _a113;
  response.writeHead((_a113 = init == null ? void 0 : init.status) != null ? _a113 : 200, {
    "Content-Type": "text/plain; charset=utf-8",
...
var generateId22 = generateId2;
var nanoid = generateId2;
export {
